...
<div class="notice notice-success is-dismissible gutenify-business-dark-admin-notice">
	<div class="gutenify-business-dark-admin-notice-wrapper">
		...
		<p><?php esc_html_e( 'We strongly recommend installing plugin: ', 'gutenify-business-dark' ); ?> <strong><?php esc_html_e( 'Gutenify', 'gutenify-business-dark' ); ?></strong></p>
		<p><strong><?php esc_html_e( 'Gutenify', 'gutenify-business-dark' ); ?></strong> <?php esc_html_e( 'provides multiple template kit and also add advance features to your site.', 'gutenify-business-dark' ); ?></p>
		<a href="<?php echo esc_url( admin_url( 'themes.php?page=gutenify-business-dark-info' ) ); ?>" class="gutenify-business-dark-admin-notice-primary-button"><?php esc_html_e( 'Get Templates', 'gutenify-business-dark' ); ?></a>
